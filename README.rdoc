...
If your attributes share some enum values with the same name, there will be confusing as to which
...
to use the same methods defined in the object itself.  You can back off the strictness
